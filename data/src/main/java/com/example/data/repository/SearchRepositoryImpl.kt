...
class SearchRepositoryImpl @Inject constructor(
    ...
    override suspend fun searchImage(
        ...
        searchRemoteDataSource.searchImage(keyword = keyword, page = page, pageSize = pageSize).documents.forEach {
            emit(
    ...
    override suspend fun searchVideo(
        ...
        searchRemoteDataSource.searchVideo(keyword = keyword, page = page, pageSize = pageSize).documents.forEach {
            emit(
